...
export class RegistracijaComponent {
  ...
  telefon: string = ''
  mejl: string = ''
  slika: string = "data:image/jpeg;base64,"
  kartica: string = ''
  greska: string = ''
  ...
  registracija() {
    this.proveraLozinke()
    if(this.greskaLozinka == "" &&  this.greskaSlika == "" && this.validna == true && this.popunjenaPolja()) {
      this.korisnikServis.registracija(this.korisnicko_ime, this.lozinka, this.ime, this.prezime, this.tip, this.pol, this.adresa, this.telefon, this.mejl, this.slika, this.kartica).subscribe(data => {
        if(data.poruka == "U") {
          alert("Registracija uspesno dodata")
          window.location.reload()
        } else if(data.poruka == "P") {
          this.greska = "Korisnik vec postoji"
        } else if(data.poruka == "RP") {
          this.greska = "Registracija vec postoji"
        } else {
          this.greska = "Registracija nije dodata"
        }
      })
    } else {
  ...
  popunjenaPolja() {
    if(this.korisnicko_ime != "" && this.ime != "" && this.prezime != "" && this.tip != "" && this.pol != "" && this.adresa != "" && this.telefon != '' && this.mejl != "") {
      return true
    } else {
      return false
    }
